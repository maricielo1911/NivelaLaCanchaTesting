...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221119_nivelalacancha_2ad4bf8939f20d7e8058_20221119220648_archive.zip';
        const ARCHIVE_SIZE       = '493493396';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '2ad4bf8-19220648';
        const SECONDARY_PACKAGE_HASH = 'b4ccd76-19220648';
        const VERSION            = '1.5.1';
